...
var html = (function() {
    ...
    res.time = function(target_id, thunk) {
        ...
        html.append_at(target_id, html.p({
            'class': 'benchmark'
        }, "Time taken: " + diff));
    };
    return res;
...
var DOM = {
     ...
     * 
     */
    createInputCheck: function() {
        return this.createInputElement('checkbox');
    },
    /**
    ...
    /**
     * Sets inner HTML on a DOM element
     *
     * @method setInnerHTML
     * @param element {Element} DOM element to set the inner HTML unto
     * @param html {String} String of parsable HTML code
     * 
     */
    ...
    /**
     * Return the inner HTML code of a DOM element
     *
     * @method getInnerHTML
     * @param element {Element} DOM element to return inner HTML from
    ...
    /**
     * Sets inner Text on a DOM element. Will remove first child if found and replace with a Text Node
     *
     * @method setInnerText
     * @param element {Element} DOM element to set the inner Text unto
    ...
    /**
     * Returns the inner Text of a DOM element. Loops thru children and returns all Inner Text of all children
     *
     * @method getInnerText
     * @param element {Element} DOM element to get inner text from
     * @return {String} All text found on all child elements appended together
     * 
     */
    ...
    /**
     * Returns clientX from an Event
     *
     * @method eventGetClientX
     * @param event {Event} Event to get the value from
     * @return {Number} The clientX value on Event
     * 
     */
    ...
    /**
     * Returns clientY from an Event
     *
     * @method eventGetClientY
     * @param event {Event} Event to get the value from
     * @return {Number} The clientY value on Event
     * 
     */
    ...
    eventGetTypeInt: function(event) {
        switch (event.type) {
            ...
            case "abort":
                return Event.ONABORT;
            case "progress":
                return Event.ONPROGRESS;
            case "loadend":
                return Event.ONLOADEND;
            case "loadstart":
                return Event.ONLOADSTART;
            case "dragstart":
                return Event.ONDRAGSTART;
            case "drag":
                return Event.ONDRAG;
            case "dragenter":
                return Event.ONDRAGENTER;
            case "dragleave":
                return Event.ONDRAGLEAVE;
            case "dragover":
                return Event.ONDRAGOVER;
            case "drop":
                return Event.ONDROP;
            case "dragend":
...
var MenuItemBase = FocusWidget.extend({
    init: function(name, href, fn, stylename) {
        ...
        this.active = false;
        var self = this;
        this.addClickListener(function(evt) {
            self.onClick(evt);
        });
        if (this.callback)
